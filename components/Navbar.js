...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-950 shadow-lg text-white flex justify-between px-4 items-center h-16">
      ...
      <div className="relative">
        {session && 
          <>
            <button onClick={()=>setshowdropdown(!showdropdown)} onBlur={()=>setshowdropdown(false)}
            ...
            <div
              id="dropdown"
              className={`z-10 ${showdropdown?"":"hidden"} absolute left-[170px] bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}
            >
              <ul
        ...
        {!session && 
          <Link href={"/login"}>
            <button className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-1 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
              Login
            </button>
          </Link>
        }
